...
class MusicPlayer {
    constructor() {
        ...
        this.isMuted = false;
        // 预留音乐文件路径，后续可以替换为实际音乐文件
        this.defaultMusicPath = './music/background.mp3'; // 预留路径
        this.init();
    }
    ...
    loadDefaultMusic() {
        // 设置默认音乐文件
        this.audioPlayer.src = this.defaultMusicPath;
        this.musicInfo.textContent = '背景音乐';
        this.audioPlayer.loop = true; // 循环播放
    }
        ...
        if (!this.isPlaying) {
            ...
            if (playPromise !== undefined) {
                playPromise.then(() => {
                    ...
                    this.musicInfo.textContent = '点击播放音乐';
                });
            }
        }
    }
